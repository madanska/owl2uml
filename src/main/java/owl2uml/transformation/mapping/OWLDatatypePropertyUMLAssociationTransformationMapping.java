 ...
 * @version June 2006
 */
public class OWLDatatypePropertyUMLAssociationTransformationMapping {
	private String umlVariable = "";
	private String owlVariable = "";
	private String ifCondition = "";
	private String ifConditionValue = "";
	private Category tracer = Logger.getLogger(OWLDatatypePropertyUMLAssociationTransformationMapping.class);

	public OWLDatatypePropertyUMLAssociationTransformationMapping() {
