 ...
 * @version June 2006
 */
public class OWLDatatypePropertyUMLOperationTransformationMapping {
	...
	private Category tracer = Logger.getLogger(OWLDatatypePropertyUMLOperationTransformationMapping.class);

	public OWLDatatypePropertyUMLOperationTransformationMapping() {
