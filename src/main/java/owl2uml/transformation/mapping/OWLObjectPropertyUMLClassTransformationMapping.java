 ...
 * @version June 2006
 */
public class OWLObjectPropertyUMLClassTransformationMapping {
	private String umlVariable = "";
	private String owlVariable = "";
	private String ifCondition = "";
	private String ifConditionValue = "";
	private Category tracer = Logger.getLogger(OWLObjectPropertyUMLClassTransformationMapping.class);

	public OWLObjectPropertyUMLClassTransformationMapping() {
