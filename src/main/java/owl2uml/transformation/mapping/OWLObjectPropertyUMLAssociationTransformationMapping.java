...
public class OWLObjectPropertyUMLAssociationTransformationMapping {
	private String umlVariable = "";
	private String owlVariable = "";
	private String ifCondition = "";
	private String ifConditionValue = "";
	private Category tracer = Logger.getLogger(OWLObjectPropertyUMLAssociationTransformationMapping.class);

	public OWLObjectPropertyUMLAssociationTransformationMapping() {
