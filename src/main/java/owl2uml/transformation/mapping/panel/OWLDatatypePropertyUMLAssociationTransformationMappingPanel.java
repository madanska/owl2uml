 ...
 * @version June 2006
 */
public class OWLDatatypePropertyUMLAssociationTransformationMappingPanel extends JPanel {
	...
	protected Category tracer = Logger.getLogger(OWLDatatypePropertyUMLAssociationTransformationMappingPanel.class);
	...
	public OWLDatatypePropertyUMLAssociationTransformationMappingPanel(JDialog ownerDialog,
	...
	public void readTransformationMapping(OWLDatatypePropertyUMLAssociationTransformationMapping mapping) {
	...
	public void writeTransformationMapping() {
		OWLDatatypePropertyUMLAssociationTransformationMapping mapping = new OWLDatatypePropertyUMLAssociationTransformationMapping();
		tracer.debug("Creating new OWLDatatypePropertyUMLAssociationTransformationMapping instance");
		...
		umlAssociationGraphCell.setOwlDatatypePropertyUmlAssociationTransformationMapping(mapping);
	}
