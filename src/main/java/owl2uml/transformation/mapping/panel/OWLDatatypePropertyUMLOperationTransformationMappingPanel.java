 ...
 * @version June 2006
 */
public class OWLDatatypePropertyUMLOperationTransformationMappingPanel extends JPanel {
	...
	protected Category tracer = Logger.getLogger(OWLDatatypePropertyUMLOperationTransformationMappingPanel.class);
	...
	public OWLDatatypePropertyUMLOperationTransformationMappingPanel(JDialog ownerDialog,
	...
	public void readTransformationMapping(OWLDatatypePropertyUMLOperationTransformationMapping mapping) {
	...
	public void writeTransformationMapping() {
		OWLDatatypePropertyUMLOperationTransformationMapping mapping = new OWLDatatypePropertyUMLOperationTransformationMapping();
		tracer.debug("Creating new OWLDatatypePropertyUMLOperationTransformationMapping instance");
		...
		umlOperationGraphCell.setOWLDatatypePropertyUMLOperationTransformationMapping(mapping);
	}
