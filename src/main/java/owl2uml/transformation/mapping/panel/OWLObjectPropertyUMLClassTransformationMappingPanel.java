 ...
 * @version June 2006
 */
public class OWLObjectPropertyUMLClassTransformationMappingPanel extends JPanel {
	...
	protected Category tracer = Logger.getLogger(OWLObjectPropertyUMLClassTransformationMappingPanel.class);
	...
	public OWLObjectPropertyUMLClassTransformationMappingPanel(JDialog ownerDialog,
	...
	public void readTransformationMapping(OWLObjectPropertyUMLClassTransformationMapping mapping) {
	...
	public void writeTransformationMapping() {
		OWLObjectPropertyUMLClassTransformationMapping mapping = new OWLObjectPropertyUMLClassTransformationMapping();
		tracer.debug("Creating new OWLObjectPropertyUMLClassTransformationMapping instance");
		...
		umlClassGraphCell.setOWLObjectPropertyUMLClassTransformationMapping(mapping);
	}
